...
let CommentsController = class CommentsController {
    ...
    async createComment(ticketId, comment, user) {
        ...
        const ticketInfo = await entity_2.TicketInfo.findOne({ ticket });
        if (!ticketInfo)
            throw new routing_controllers_1.NotFoundError('Not a ticket');
        ...
        const infoPayload = await entity_2.TicketInfo.query(`SELECT * FROM ticket_infos;`);
